...
namespace ProjectAConsoleApp.DayThree
{
    internal class StringLessons
    {
        ...
        public static void TestStringEquals()
        {
            ...
            Console.WriteLine("firstString==fourthString" + (firstString == fourthString));
            Console.WriteLine("firstString.Equals(fourthSting)" + firstString.Equals(fourthString));
        }
        public static void TestSubstring()
        {
            ...
            //from the 5th Index to next 10 char
